                ...
                <div className="col-sm-12">
                    <div className="card sett-pg">
                        ...
                        <div class="pro-img">
                            ...
                            />
                            <img src="../../assets/img/profile-avatar.png" alt="Avatar" class="image" ref={uploadedImage}/>
                            <div class="overlay" onClick={() => imageUploader.current.click()}>
                                <a class="pro-img-icon" title="User Profile">
