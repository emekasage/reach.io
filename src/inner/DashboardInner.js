				...
				<div className="container-fluid p-0">
					...
					<div className="d-flex justify-content-between inner-text">
						<div className="heading-col">
							<h5><strong>Overview:</strong> Campaign 1</h5>
							<h5 className="cred-rem"><strong>Credit Remaining:</strong> 2000</h5>
						</div>
							...
							<div className="w-100">
								<div className="row">
									<div className="col-sm-6">
										<div className="card tiny-cards">
											<div className="card-body">
												<div onClick={()=>setShowRadial1(!showRadial1) } className="d-flex justify-content-between top-card-content">
														<h5 className="card-title mb-4">No. of Emails Collected</h5>
														<i class="bi bi-circle-half moon"></i>
												</div>
												<div className={`r-chart ${!showRadial1 ? "show" : "hide"}`}>
													<div className="mb-1 mid-card-content">
														<h1 className="mt-1 mb-3">100</h1>
														<span className="text-success"> +34% </span>
													</div>
													<div className="mb-1">
														<span className="text-muted">compared to last week</span>
													</div>
												</div>
												<div className={`r-chart ${showRadial1 ? "show" : "hide"}`}>
													<RadialChart value="50"/>

													<span className="percentage d-flex justify-content-center">25%</span>
													<span className="reach-text d-flex justify-content-center">Reached</span>

													<span className="reach-btm-text d-flex justify-content-center">Compared to last week</span>
										...
										<div className="card tiny-cards">
											<div className="card-body">
												<div onClick={()=>setShowRadial2(!showRadial2) } className="d-flex justify-content-between top-card-content">
													<h5 className="card-title mb-4">No. of Telephone numbers</h5>
													<i class="bi bi-circle-half moon"></i>
												</div>
												<div className={`r-chart ${!showRadial2 ? "show" : "hide"}`}>
													<div className="mb-1 mid-card-content">
														<h1 className="mt-1 mb-3">100</h1>
														<span className="text-success"> +34% </span>
													</div>
									...
									<div className="col-sm-6">
										<div className="card tiny-cards">
											<div className="card-body">
                                            	<div onClick={()=>setShowRadial3(!showRadial3) } className="d-flex justify-content-between top-card-content">
												    <h5 className="card-title mb-4">No. of Emails Collected</h5>
                                                    <i class="bi bi-circle-half moon"></i>
                                                </div>
												<div className={`r-chart ${!showRadial3 ? "show" : "hide"}`}>
													<div className="mb-1 mid-card-content">
														<h1 className="mt-1 mb-3">100</h1>
														<span className="text-success"> +34% </span>
													</div>
										...
										<div className="card tiny-cards">
											<div className="card-body">
                                            	<div  onClick={()=>setShowRadial4(!showRadial4) } className="d-flex justify-content-between top-card-content">
												    <h5 className="card-title mb-4">No. of First Replies</h5>
                                                    <i class="bi bi-circle-half moon"></i>
                                                </div>
												<div className={`r-chart ${!showRadial4 ? "show" : "hide"}`}>
													<div className="mb-1 mid-card-content">
														<h1 className="mt-1 mb-3">100</h1>
														<span className="text-success"> +34% </span>
													</div>
						...
						<div className="col-12 col-lg-12 col-xxl-9 d-flex">
							<div className="card flex-fill">
								<div className="card-header table-card-head d-flex justify-content-between">
									...
									<select className="form-select form-select-sm col-select" aria-label="Default select example">
										<option selected hidden>Select a column</option>
